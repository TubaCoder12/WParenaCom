...
export default function Footer() {
  return (
    <footer
      className="relative bg-cover bg-center bg-no-repeat text-white py-10 mt-8 px-4 md:px-8 lg:px-12"
    ...
    >
      ...
      <div className="text-center mb-8">
        ...
        <div className="flex justify-center items-center mb-4">
          <Image src="/Footer-logo.png" alt="WP Arena Logo" width={200} height={200} className="w-48 h-auto" />
        </div>

        {/* Description */}
        <p className="text-gray-300 max-w-4xl mx-auto text-sm leading-relaxed px-4 md:px-8">
      ...
      <div className="flex justify-center flex-wrap gap-4 mb-6">
        {[FaFacebookF, FaXTwitter, FaLinkedin, FaInstagram, FaYoutube, PiGitlabLogo].map((Icon, index) => (
          <a key={index} href="#" className="text-white hover:bg-blue-400 border border-gray-400 rounded-full p-3 transition duration-300">
